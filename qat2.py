...
logger.info("Loading trained float model...")
float_model = tf.keras.models.load_model(
    "output/efficientnet_v2_m_mushrooms",
    compile=False
)

float_model.summary()

logger.info("!!!! model instance type !!!!")
logger.info(type(float_model))
logger.info(isinstance(float_model, tf.keras.Model))
logger.info(float_model.__class__.__mro__)


# Freeze BatchNorm BEFORE QAT
